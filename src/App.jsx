...
const tipoDe=(k)=>TIPOGRAFIAS[k]||TIPOGRAFIAS.cambria;
...
const EMPTY = {
  ...
  predioNombre:"",localidad:"",provincia:"",region:"",tipografia:"cambria",
...
export default function App(){
  ...
  const exportarWord=()=>{
    ...
    const estilos="@page Seccion1{size:21.0cm 29.7cm;margin:2.0cm 1.8cm 2.2cm 1.8cm;mso-page-orientation:portrait;mso-footer:f1;mso-footer-margin:1.2cm;}"+
      ...
      "body{font-family:"+TIPO.texto+";font-size:11pt;color:#1f1f1f;line-height:1.45;}"+
      "h1{font-family:"+TIPO.tit+";color:#1a1a1a;font-size:21pt;text-align:center;margin:10pt 0;}"+
      "h2{font-family:"+TIPO.tit+";color:#1e5631;font-size:13.5pt;border-bottom:1.5pt solid #1e5631;padding-bottom:3pt;margin:0 0 12pt;page-break-after:avoid;}"+
      ...
      "img{max-width:100%;}"+
      "p.MsoFooter{font-family:"+TIPO.texto+";font-size:8.5pt;color:#8a8a8a;border-top:0.5pt solid #d8d8d8;padding-top:3pt;margin:0;}";
...
#informe>div{width:210mm!important;min-height:297mm!important;box-sizing:border-box!important;padding:16mm 15mm 22mm!important;background:#fff!important;box-shadow:0 2px 14px rgba(0,0,0,0.16)!important;margin:0 auto 9mm!important;border-top:none!important;position:relative}
...
@media print{
  ...
  .print-footer{display:block!important;position:fixed;left:0;right:0;bottom:-13mm;height:11mm;padding-top:2mm;border-top:1px solid #d8d8d8;font-size:8.5pt;color:#8a8a8a}
          ...
          <div>
            <div className="noprint" style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:18}}>
              ...
              <div style={{display:"flex",gap:10,alignItems:"center"}}>
                ...
                <select value={form.tipografia||"cambria"} onChange={e=>upd("tipografia",e.target.value)} style={{...iS,width:250,margin:0,padding:"7px 8px",fontSize:12.5}}>
